...
namespace BloodKoshh.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        private readonly SignInManager<BloodKoshhUser> _signInManager;
        private readonly UserManager<BloodKoshhUser> _userManager;
        private readonly ILogger<RegisterModel> _logger;
        private readonly IEmailSender _emailSender;

        public RegisterModel(
            UserManager<BloodKoshhUser> userManager,
            SignInManager<BloodKoshhUser> signInManager,
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new BloodKoshhUser { UserName = Input.Email, Email = Input.Email, Role= Input.Role };
